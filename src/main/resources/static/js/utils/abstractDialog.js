...
(function() {
  this.AbstractDialog = (function() {
    ...
    AbstractDialog.prototype.show = function() {
      ...
      this.container.html(this._templateWrapperHTML());
