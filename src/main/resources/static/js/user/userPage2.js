...
(function() {
  this.UserProfile2 = (function() {
    ...
    UserProfile2.prototype.getPageTitle = function() {
      return 'Profile';
    };

    UserProfile2.prototype.destroy = function() {
    ...
    UserProfile2.prototype._clickEventHandler = function(event) {
      var target;
      target = $(event.target);
    ...
    UserProfile2.prototype._renderUserInfo = function(user) {
    ...
    UserProfile2.prototype.editProfileDialogSuccess = function(user) {
    ...
    UserProfile2.prototype._html = function() {
